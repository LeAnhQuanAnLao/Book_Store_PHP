...
@section('content')
    <div class="container form-container">
        ...
        <form action="{{ url('/admin/hocsinh/create') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="training_type" id="training_type" required>
            </div>
            <div class="form-group">
